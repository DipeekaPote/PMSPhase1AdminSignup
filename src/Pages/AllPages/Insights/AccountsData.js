...
import LoadingWithLogo from "../../../Components/Sidebar/LoadingWithLogo";
...
const AccountsData = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setLoading(false); // Set loading to false after 2000 milliseconds
    }, 2000);
  ...
  if (loading) {
    // If loading, render LoadingWithLogo component
